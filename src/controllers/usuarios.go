...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	//portanto erro continuará sendo nil e será necessário ver se o statuscode da resposta equivale a um erro
	//isso é necessário para saber por que deu erro para avisar o usuário o motivo
